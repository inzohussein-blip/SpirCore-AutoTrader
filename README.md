...
أساس تقني لتحويل النظام إلى منتج: **مستخدمون + تراخيص مربوطة بحساب MT5 + هيكل اشتراكات (Stripe) + صفحة أداء عامة**، قابل للنشر عبر Docker (بلا اعتماد على MetaTrader5). يتحقق الـ EA من الترخيص عبر `InpUseLicense`، ويدفع الجسر الأداء عبر `SAAS_URL`. التفاصيل في **[saas/README.md](saas/README.md)**.
